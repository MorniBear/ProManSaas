...
class Project(models.Model):
    ...
    user_name = models.CharField(max_length=128, verbose_name='拥有者名')
    status = models.CharField(max_length=128, choices=project_state, verbose_name="项目状态")
...
class Question(models.Model):
    ...
    questioner = models.ForeignKey('User', on_delete=models.CASCADE, verbose_name='提问人')
    ...
    new_question = models.ForeignKey('self', on_delete=models.CASCADE, verbose_name='追答问题id')
...
class QuestionStatus(models.Model):
    ...
    project = models.ForeignKey('Project', on_delete=models.CASCADE, verbose_name='所属项目')
    project_name = models.CharField(max_length=128, default=project.name, auto_created=True, verbose_name='项目名')
    c_time = models.DateTimeField(auto_now_add=True, verbose_name="创建时间")
    f_time = models.DateTimeField(auto_now=True, verbose_name="修改时间")
...
class ProjectMission(models.Model):
    ...
    user = models.ForeignKey('ProjectMember', on_delete=models.CASCADE, verbose_name='所属项目成员')
    project = models.ForeignKey('Project', on_delete=models.CASCADE, verbose_name='所属项目')
    mission_process = models.PositiveIntegerField(verbose_name='任务进度', default=0, auto_created=True)
    belong_mission = models.ForeignKey('ProjectMission', on_delete=models.CASCADE, related_name='it_belong_to',
                                       verbose_name='所属任务', )
...
class ProjectFile(models.Model):
    ...
    mission = models.ForeignKey('ProjectMission', on_delete=models.CASCADE, verbose_name="所属任务ID")
    member = models.ForeignKey('ProjectMember', on_delete=models.CASCADE, verbose_name="所属项目成员ID")
...
class ProjectMember(models.Model):
    ...
    exit_time = models.TimeField(verbose_name='退出时间', null=True, default=None, auto_created=True)
    c_time = models.DateTimeField(auto_now_add=True, verbose_name="创建时间")
    f_time = models.DateTimeField(auto_now=True, verbose_name="修改时间")
...
class ProjectResource(models.Model):
    ...
    project = models.ForeignKey('Project', on_delete=models.CASCADE, verbose_name='所属项目')
    user = models.ForeignKey('User', on_delete=models.CASCADE, verbose_name='所属用户')
    member = models.ForeignKey('ProjectMission', on_delete=models.CASCADE, verbose_name="所属项目成员ID")
    c_time = models.DateTimeField(auto_now_add=True, verbose_name="创建时间")
    f_time = models.DateTimeField(auto_now=True, verbose_name="修改时间")
